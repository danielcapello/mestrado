...
def normalização(dados):
    ...
    #return min_max_scaler.fit_transform(dados)
...
def clf_svm(x_train, x_test, y_train, y_test, x_valid, y_valid):
    ...
    #dump(clf_svm_rbf, '/home/kplo/Documentos/Mestrado/Classificadores_salvos/clf_svm_rsaxelg_10kbits.joblib')
...
def clf_random(x_train, x_test, y_train, y_test, x_valid, y_valid):
    ...
    #dump(clf_random, '/home/kplo/Documentos/Mestrado/Classificadores_salvos/clf_random_rsaxelg_10kbits.joblib')
...
def clf_knn(x_train, x_test, y_train, y_test, x_valid, y_valid):
    ...
    #dump(clf_KNN, '/home/kplo/Documentos/Mestrado/Classificadores_salvos/clf_knn_rsaxelg_10kbits.joblib')
...
def principal_ml(arq1, arq2, arq4, arq5):
    base_toda_trein_test = construir_base(arq1, arq2)
    base_toda_valid = construir_base(arq4, arq5)
    #print("leitura ok")
...
resultados_finais = []
for i in range(32):
    resultados_rodada = ['150k', 'ELG', 'RSA']
    matriz_trein_final, matriz_teste_final, matriz_valid_final, algoritmo_final = principal_ml('/home/kplo/Documentos/Mestrado/Vetores/Vetores_1024/ELG/Elgamal_base_1024_Trein_Valid_vetor_8_150kbits_2kamostras.npy',
              '/home/kplo/Documentos/Mestrado/Vetores/Vetores_1024/RSA/RSA_base_1024_Trein_Valid_vetor_8_150kbits_2kamostras.npy',
...
df_resultados = pd.DataFrame(data=resultados_finais, columns=['No_bits','Classe_1','Classe_2','Algoritmo_ML', 'Trein_A', 'Trein_B', 'Trein_C', 'Trein_D', 'Test_A', 'Test_B', 'Test_C', 'Test_D', 'Valid_A', 'Valid_B', 'Valid_C', 'Valid_D'])
df_resultados.to_excel('/mnt/c/Users/kpl0/Documents/export_ubuntu/32x_KNN_rsa_elg_150k.xlsx')
